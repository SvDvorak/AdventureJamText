...
{
    public class GlulxStateService_Old
    {
        #region Singleton Pattern

        protected static GlulxStateService_Old _instance;

        public static GlulxStateService_Old Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new GlulxStateService_Old();
                }
